...
//         CreateCinemaDTO cinema2 = new CreateCinemaDTO("Советсувб 10", "Ривьера", "Бутырска");
//         cinemaService.create(cinema2);

//         CreateHallDTO hall1 = new CreateHallDTO(110, 1);
//         hallService.create(hall1);

//         CreateSessionDTO session = new CreateSessionDTO(new Date(124, 04, 01, 1, 32, 0), 1, 2, 1, 2);
//         sessionService.create(session);
//         CreateSessionDTO session1 = new CreateSessionDTO(new Date(124, 10, 01, 1, 32, 0), 1, 2, 2, 100);
